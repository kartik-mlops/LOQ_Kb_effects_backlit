...
**To just run the app:** Windows 10/11, a Lenovo LOQ (or similar Lenovo/Legion laptop) with the white 2-level keyboard backlight, and Administrator privileges (the WMI backlight method requires elevation). That's it — download and run.

**To run or modify the source instead:** Python 3.10+ as well.

## Running from source (optional)

Only needed if you want to modify the code or don't trust running a random `.exe` from the internet (fair enough — you can read the source yourself instead).
