...
**[⬇ Download the latest .exe](https://github.com/kartik-mlops/LOQ_Kb_effects_backlit/releases/latest)** — no Python, no setup. Just download and run it.
...
```bash
git clone https://github.com/kartik-mlops/LOQ_Kb_effects_backlit.git
cd LOQ_Kb_effects_backlit
